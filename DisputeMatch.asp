...
strSQL = "SELECT GameID, LadderID, LadderName, LadderAbbreviation FROM tbl_ladders WHERE LadderName = '" & CheckString(strLadderName) & "' AND LadderActive = 1"
...
If Not(bSysAdmin or IsLadderAdmin(strLadderName) or _
	...
	IsTeamCaptain(strAttackerTeam, strLadderName) Or IsTeamCaptain(strDefenderTeam, strLadderName)) Then 
