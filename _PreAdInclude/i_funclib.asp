...
Function ForumEncodeOld(byVal strBody)
	...
	strEncoded = Replace(strEncoded, "[/i]", "</I>", 1, -1, 1)
	strEncoded = Replace(strEncoded, "[/u]", "</U>", 1, -1, 1)
	strEncoded = Replace(strEncoded, "[img]", "<img src=""", 1, -1, 1)
	strEncoded = Replace(strEncoded, "[/img]", """>", 1, -1, 1)
...
Function ParseForumCode(strInput)
	...
	strOutput = RegExpReplace(strOutput, "(\[img\])([\w\W]*?)(\[/img\])", "<img src=""$2"" border=""0"" />")
