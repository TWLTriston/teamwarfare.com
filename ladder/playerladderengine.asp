...
if Request.Form("saveType") = "changeDate" then
	...
	finaltime = timearray(0) & ":" & timearray(1) & " PM EST"
	dispTimeString = timearray(0) & ":" & timearray(1) & ":00" 
	strSQL="UPDATE tbl_Playermatches SET" &_
	" MatchDate='" & finaldate & " " & FinalTime & "'" &_
	" WHERE PlayerMatchID='" & Request.Form("matchid") & "'"
