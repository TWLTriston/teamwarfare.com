...
%>
	...
	<center>
		<br />
	<center>
		<!-- BEGIN: AdSolution-Website-Tag 4.3 : Teamwarfare.com / Teamwarfare. com_Misc_Island -->
		<script language="javascript" type="text/javascript">
		Ads_kid=0;Ads_bid=0;Ads_xl=0;Ads_yl=0;
		</script>
		<script type="text/javascript" language="javascript" src="http://a.as-us.falkag.net/dat/cjf/00/09/33/59.js"></script>
