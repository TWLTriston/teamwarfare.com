...
function clsStyle() {
	...
	this.OnBackgroundColor = "#132C15";
	this.OnColor = "#ffd142";
	this.OffBackgroundColor = "#123416";
...
/*		if (document.getElementById("divAdSpace1")) {
			document.getElementById("divAdSpace1").style.visibility = "hidden";
		}
		if (document.getElementById("divAdSpace2")) {
			document.getElementById("divAdSpace2").style.visibility = "hidden";
		}
*/
	}
}
...
/*		if (document.getElementById("divAdSpace1")) {
			document.getElementById("divAdSpace1").style.visibility = "visible";
		}
		if (document.getElementById("divAdSpace2")) {
			document.getElementById("divAdSpace2").style.visibility = "visible";
		}
*/
	}
