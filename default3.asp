...
%>
	...
	<% Call Content2BoxMiddle() %>
		...
		<br />
	<%
	Dim objHPBanner, strBanner
	Set objHPBanner = Server.CreateObject( "MSWC.ContentRotator" )
	strBanner = objHPBanner.ChooseContent("hpbanners.txt")
	Set objHPBanner = Nothing
