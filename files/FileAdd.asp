	...
	<TR>
		<TD>
			<table align=center border=0 cellpadding=4 cellspacing=1>
				<TR BGCOLOR="#000000">
					<TH COLSPAN=2>Upload to File library</TH>
				</TR>
				<tr BGCOLOR="<%=bgcone%>">
					...
					<TD><SELECT NAME="CATEGORY">
						...
						If Not(ors.EOF and ors.bof) Then
							Do While Not(ors.EOF)
								Response.Write "<OPTION VALUE=""" &  oRS.Fields("FileCategoryID").Value & "|" &  oRS.Fields("Directory").Value & """>" & oRS.Fields("CategoryName").Value & "</OPTION>"
								oRS.MoveNext
							Loop
						End If
						ors.Close
				...
				<TR BGCOLOR="<%=bgcone%>">
					...
					<TD><TEXTAREA COLS=20 ROWS=5 NAME="Description"></TEXTAREA>
				</TR>
				<tr BGCOLOR="<%=bgctwo%>">
