...
%>
	...
	<% Call Content2BoxMiddle() %>
		...
		<br />
<br /><center><a href="/stuff/">Check out our new official TWL Mousepads!<br /><img src="/images/pad/banner.jpg" height="115" width="360" alt="Official TeamWarfare Mousepads - Learn More" border="0" /></a></center>
	<% Call Content2BoxEnd() %>
	<% 
