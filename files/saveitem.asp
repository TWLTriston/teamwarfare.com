...
If Request.QueryString("SaveType") = "DeleteFile" Then
	...
	End If
	Set objFSO = Nothing
	strSQL = "INSERT INTO tbl_transaction (TransactionDetails, TransactionTime) VALUES ('Delete File - " & Session("uName") & " - " & Request.ServerVariables("REMOTE_ADDR") & " - deleted " & strFileName & " from group " & strDirectory & "', GetDate())"
	oConn.Execute (strSQL)
End If
