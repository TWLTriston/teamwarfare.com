...
Call ContentStart("")
	...
	strSQL = "select * from tbl_Comms where matchID='" & intMatchID & "' order by CommID desc"
	...
	if not (ors.EOF and ors.bof) then
		do while not ors.EOF
			...
			Response.Write "<tr bgcolor="& bgc & "><td>Author: <b>" & ors.Fields(2).Value & " - Posted: " & FormatDateTime(ors.Fields(1).Value, 0) & "</td></tr>" & vbCrLf
