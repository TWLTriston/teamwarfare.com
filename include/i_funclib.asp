...
Function TrackSession()
	...
	sSQL = "EXECUTE UpdateSession @PlayerHandle = '" & CheckString(Session("uName")) & "', @LastPageView = '" & CheckString(Left(Request.ServerVariables ("PATH_INFO") & "?" & Request.QueryString, 500)) & "', @SessionID = '" & CheckString(Session.SessionID) & "', @IPAddress = '" & CheckString(Request.ServerVariables("REMOTE_HOST")) & "'"
	oConn.Execute(sSQL)
End Function
...
Function ForumEncodeOld(byVal strBody)
	...
	' BB Codes
	strEncoded = strBody
	strEncoded = Replace(strEncoded, "[b]", "<strong>", 1, -1, 1)
	strEncoded = Replace(strEncoded, "[i]", "<em>", 1, -1, 1)
	...
	strEncoded = Replace(strEncoded, "[/img]", """ alt=""""></div>", 1, -1, 1)
...
Sub DisplayForumLegend()
	Response.Write "<tr>"
	Response.Write "<td ALIGN=""center"" CLASS=""legend""><img src=""/images/lighton.gif"" border=""0"" alt=""new posts"" /> New posts "
	Response.Write "<img src=""/images/lightoff.gif"" border=""0"" alt=""no new posts"" /> No new posts "
	Response.Write "<img src=""/images/locked.gif"" border=""0"" alt=""locked"" /> A closed forum "
	Response.Write "</td>"
	Response.Write "</tr>"
End Sub
...
Sub DisplayThreadLegend()
	...
	Response.Write "<td ALIGN=""center"" CLASS=""legend""><img src=""/images/lighton.gif"" border=""0"" alt=""new posts"" /> New posts "
	Response.Write "<img src=""/images/lightoff.gif"" border=""0"" alt=""no new posts"" /> No new posts "
	Response.Write "<img src=""/images/locked.gif"" border=""0"" alt=""locked"" /> Closed thread "
	Response.Write "</td>"
	Response.Write "</tr>"
End Sub
...
Function ForumEncode2(strInput)
	...
	sOut = TWLDomainFix(sOut)
	sOut = RegExpReplace(sOut, "(bnradw)", "***VIRUSURL***")
	sOut = RegExpReplace(sOut, "(suppadw)", "***VIRUSURL***")	
...
Function ForumEncode(byVal strBody)
	...
	ForumEncode = sOut
End Function
Function TWLDomainFix(strInput)
	Dim sOut
	sOut = strInput
'	sOut = RegExpReplace(sOut, "(^|[^@])(http:\/\/)?(www\.)?teamwarfare\.(com|net|org)\/", "$1/")
	TWLDomainFix = sOut
End Function
