...
function fCenterMenus() {
	...
	document.getElementById("divMenurules").style.visibility = "visible";
	document.getElementById("divMenucomp").style.visibility = "visible";
